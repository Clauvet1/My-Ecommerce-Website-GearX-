...
<body>
    <div class="main">
        <div class="header">
            <div class="box">
                <h1>ABOUT US</h1>
            <h5>The GearX company</h5>
            </div>
        
            <?php include'includes/navbar.php' ?>
            <div class="bottom_text">
              <p>ducimus eum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam vitae, reiciendis perferendis molestiae facere dignissimos sed, aut debitis autem error animi deleniti quisquam ducimus, voluptas dolor ad dolore. Inventore, non?</p>
            </div>
          </div>
          <div class="content1">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="text-black">SERVICE PROVIDER</h1>
                ...
                <div class="col-lg-6">
                    <video class="shadow-lg" width="480px" height="360px" controls>
                        <source src="videos/Activities & The Activity Lifecycle - Android Basics 2023.mp4" type="video/mp4">
                    </video>
                    <a href="http://">
                        <h3 class="apply">Apply To Join Our Team</h3>
                    </a>
          ...
          <div class="content2">
            <div class="bg_red">
                <div class="row">
                    <div class="col-lg-6">
                        WE PRODUCE AND SELL ALL KINDS OF INDUSTRIAL EQUIPMENTS Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit, minima! Culpa molestiae, dolores consectetur reiciendis at alias veritatis sunt. Cupiditate, dolores architecto laudantium magni necessitatibus numquam nihil neque explicabo ex.
                    </div>
            ...
            <div class="IMG_worker shadow-lg">
                  <img class="img" src="images/man.jpg" alt="">
            </div>
            <div class="IMG_workerB shadow-lg">
              <div class="row">
                <div class="col-lg-3">
                  <img class="img" src="images/h.jpg" alt="">
                  </div>
            ...
            <div class="views">
              <div class="row">
                <div class="col-lg-4 text-center">
                  <img class="imgX" src="images/profileC.jpg" alt="">
          ...
          <div class="content4">
            <div class="rec">
              <div class="row">
                <div class="col-lg-5 shadow mx-1 pt-4" id="p_i">
                  <div>
                    <p>Welcoming you ........</p>
                  </div>
                  <div>
