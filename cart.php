...
<body>
    <div class="main">
        <div class="shop_header">
          ...
          <div class="cc">
            <h1 class="H">SHOPPING CART</h1>
          <p class="text-white mx-5 " id="cc">HOME <img class="mx-3"  src="images/right-arrow.png" alt=""> <span class="text-danger mx-1">SHOPPING CART</span></p>
        ...
        <div class="form">
            <form action="">
                ...
                <div class="box_shop2">
                    <div class="row">
                        <div class="col-lg-3 p-4 m-4" id="f">
                            <h2>Compare code</h2>
                            <div>
                                <input type="text" placeholder="Enter compare code" name="" id="">
                            </div>
                            <div>
                                <button class="mt-3 px-5 border-danger p-2" type="submit">Apply</button>
                            </div>
                        </div>
                        <div class="col-lg-3 m-4 p-4" id="f">
...
<select class="form-select" id="country" name="country">
    ...
    <option value="ZW">Zimbabwe</option>
                            ...
                            <div><label for="">PostCode</label></div>
                            <div><input type="text" name="" id=""></div>
                        </div>
                        <div class="col-lg-4 m-4 p-4" id="f">
                            <h2>Cart totals</h2>
                            <div>
